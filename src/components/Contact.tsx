      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                  ...
                  <div key={index} className="flex items-start space-x-4 group">
                    ...
                    <div className="flex-1">
                      ...
                      <a
                        ...
                        target={info.label === 'Institution' ? '_blank' : undefined}
                        rel={info.label === 'Institution' ? 'noopener noreferrer' : undefined}
                      >
                        {info.value}
                      </a>
                    </div>
            ...
            {/* Social Links */}
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-white/50 shadow-xl">
              <h3 className="text-2xl font-semibold text-slate-800 mb-6">Research Profiles</h3>
              <div className="grid grid-cols-1 gap-4">
                {socialLinks.map((link, index) => (
                  <a
                    ...
                    className="flex items-center justify-between p-4 bg-slate-50 hover:bg-blue-50 rounded-2xl transition-all duration-300 group hover:scale-105"
                  >
                    <div className="flex items-center space-x-3">
                      <span className="text-2xl">{link.icon}</span>
                      <span className="text-slate-700 group-hover:text-blue-600 font-medium">{link.name}</span>
                    </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300 resize-none"
                    placeholder="Tell me about your research interest, collaboration ideas, or questions..."
                  />
                </div>
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 hover:shadow-lg"
                >
                  Send Message
                  <Send size={20} />
                </button>
