...
export const Hero = () => {
  ...
  return <div className="relative min-h-screen flex items-center justify-center pt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="flex flex-wrap gap-4">
              <button onClick={() => scrollToSection('publications')} className="group px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-300 flex items-center gap-2 hover:scale-105 hover:shadow-lg">
                <FileText size={20} />
                View Publications
                <ChevronDown className="group-hover:translate-y-1 transition-transform" size={16} />
              </button>
              <button onClick={() => scrollToSection('contact')} className="px-8 py-3 border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white rounded-lg font-medium transition-all duration-300 flex items-center gap-2 hover:scale-105">
                <Mail size={20} />
                Contact
              </button>
            </div>
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="relative">
              <div className="w-full h-80 lg:h-96 rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-blue-100 to-blue-200">
                <img src="/lovable-uploads/992d0a87-b112-4e7d-98fd-fd20df940492.png" alt="Dr. Shikha Singh Profile" className="w-full h-full object-center transition-transform duration-700 hover:scale-110 object-scale-down" />
              </div>
