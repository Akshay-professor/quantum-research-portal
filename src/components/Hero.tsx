...
export const Hero = () => {
  ...
  const typewriterTexts = ['Associate Professor', 'Power Electronics Expert', 'Research Innovator', 'SMPS Design Specialist'];
  useEffect(() => {
    setIsVisible(true);
  }, []);
  ...
  return <div className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      {/* Enhanced Background */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="flex flex-wrap gap-4">
              <button onClick={() => scrollToSection('publications')} className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-medium transition-all duration-300 flex items-center gap-3 hover:scale-105 hover:shadow-2xl transform">
                <FileText size={20} />
                View Publications
                <ChevronDown className="group-hover:translate-y-1 transition-transform" size={16} />
              </button>
              <button onClick={() => scrollToSection('contact')} className="px-8 py-4 border-2 border-blue-600 text-blue-600 hover:bg-gradient-to-r hover:from-blue-600 hover:to-indigo-600 hover:text-white rounded-xl font-medium transition-all duration-300 flex items-center gap-3 hover:scale-105 hover:shadow-xl backdrop-blur-sm bg-white/30">
                <Mail size={20} />
                Contact
              </button>
            </div>
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="relative">
              ...
              <div className="w-full h-64 lg:h-80 rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-blue-100 to-purple-100 relative">
                ...
                <img src="/lovable-uploads/992d0a87-b112-4e7d-98fd-fd20df940492.png" alt="Dr. Shikha Singh Profile" className="w-full h-full object-center transition-transform duration-700 hover:scale-110 object-scale-down relative z-10" />
              </div>
